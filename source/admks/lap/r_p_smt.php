...
$ke = "$filenya?tapelkd=$tapelkd&smtkd=$smtkd&keakd=$keakd&".
		"kelkd=$kelkd&rukd=$rukd&jnskd=$jnskd&page=$page";
...
if (empty($tapelkd))
	...
	if ($count != 0)
		...
		<tr>
		<td>
		[<a href="r_p_smt_pdf.php?kelkd='.$kelkd.'&rukd='.$rukd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&smtkd='.$smtkd.'&jnskd='.$jnskd.'" target="_blank"><img src="'.$sumber.'/img/pdf.gif" width="16" height="16" border="0"></a>]
		</td>
		<td align="right">
		'.$pagelist.'
		</td>
