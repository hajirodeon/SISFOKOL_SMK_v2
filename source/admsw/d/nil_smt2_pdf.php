...
//mapel
$pdf->SetX(15);
$pdf->Cell($hkr+40,$htg,'Program Pendidikan',1,0,'L',1);
...
//data mapel
$q = mysql_query("SELECT m_prog_pddkn.*, m_prog_pddkn.kd AS pelkd, m_prog_pddkn_kelas.* ".
...
do
	...
	//mapel /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//jumlah aspek
	$qpkx = mysql_query("SELECT m_aspek_prog_pddkn.*, m_aspek.*, m_prog_pddkn.* ".
							"FROM m_aspek_prog_pddkn, m_aspek, m_prog_pddkn ".
							"WHERE m_aspek_prog_pddkn.kd_prog_pddkn = m_prog_pddkn.kd ".
							"AND m_aspek_prog_pddkn.kd_aspek = m_aspek.kd ".
							"AND m_aspek_prog_pddkn.kd_keahlian = '$keakd' ".
							"AND m_aspek_prog_pddkn.kd_kelas = '$kelkd' ".
							"AND m_aspek_prog_pddkn.kd_prog_pddkn = '$pelkd'");
...
$qx = mysql_query("SELECT m_prog_pddkn.*, m_prog_pddkn.kd AS pelkd, m_prog_pddkn_kelas.* ".
					"FROM m_prog_pddkn, m_prog_pddkn_kelas ".
					"WHERE m_prog_pddkn.kd = m_prog_pddkn_kelas.kd_prog_pddkn ".
					"AND m_prog_pddkn_kelas.kd_keahlian = '$keakd'". 
					"AND m_prog_pddkn_kelas.kd_kelas = '$kelkd'". 
...
do
	...
	$qpkx = mysql_query("SELECT m_aspek_prog_pddkn.*, m_aspek.*, m_aspek.kd AS makd, m_prog_pddkn.* ".
							"FROM m_aspek_prog_pddkn, m_aspek, m_prog_pddkn ".
							"WHERE m_aspek_prog_pddkn.kd_prog_pddkn = m_prog_pddkn.kd ".
							"AND m_aspek_prog_pddkn.kd_aspek = m_aspek.kd ".
							"AND m_aspek_prog_pddkn.kd_keahlian = '$keakd' ".
							"AND m_aspek_prog_pddkn.kd_kelas = '$kelkd' ".
							"AND m_aspek_prog_pddkn.kd_prog_pddkn = '$kdx'");
	$rpkx = mysql_fetch_assoc($qpkx);
	$tpkx = mysql_num_rows($qpkx);
		...
		for ($m=1;$m<=$jmlpek;$m++)
			...
			$nrxrei = $m;
		  	...
		  	$qre = mysql_query("SELECT nilai ".
									...
									"AND ulangan_harian.kd_prog_pddkn = '$kdx' ".
...
//output-kan ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$pdf->Output("raport_akhir_$nis.pdf",I);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
?>