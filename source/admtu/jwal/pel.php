	...
	do
		...
		do
			...
			if ($tdte != 0)
				...
				<br>
				[<a href="pel_entry.php?s=edit&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'">EDIT</a>
				 - 
				 <a href="'.$filenya.'?s=hapus&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'">HAPUS</a>].
				</td>';
				}
			else
				{
