...
if ($HTTP_POST_VARS['btnSMP'])
	...
	if (!empty($nil_gdg))
		...
		if ($tcc != 0)
			...
			{
			//baru
			mysql_query("INSERT INTO m_uang_gedung(kd, kd_tapel, kd_keahlian, kd_kelas, nilai) VALUES ".
							"('$x', '$tapelkd', '$keakd', '$kelkd', '$nil_gdg')");
			}
		}	
	...
	if (!empty($nil_uji))
		...
		if ($tcc != 0)
			...
			{
			//baru
			mysql_query("INSERT INTO m_uang_ujian(kd, kd_tapel, kd_keahlian, kd_kelas, nilai) VALUES ".
							"('$x', '$tapelkd', '$keakd', '$kelkd', '$nil_uji')");
			}
		}
	...
	if (!empty($nil_spp))
		...
		if ($tcc != 0)
			...
			{
			//baru
			mysql_query("INSERT INTO m_uang_spp(kd, kd_tapel, kd_keahlian, kd_kelas, nilai) VALUES ".
							"('$x', '$tapelkd', '$keakd', '$kelkd', '$nil_spp')");
			}
		}
	...
	if (!empty($nil_lain))
		...
		if ($tcc != 0)
			...
			{
			//baru
			mysql_query("INSERT INTO m_uang_lain(kd, kd_tapel, kd_keahlian, kd_kelas, nilai) VALUES ".
							"('$x', '$tapelkd', '$keakd', '$kelkd', '$nil_lain')");
			}
		}	
