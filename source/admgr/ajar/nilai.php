...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&mapelkd='.$mapelkd.'&smtkd='.$st_kd.'">'.$st_smt.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&mapelkd='.$mapelkd.'&aspekkd='.$sp_kd.'">
	'.$sp_aspek.'</option>';
	}
