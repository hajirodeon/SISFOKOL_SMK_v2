...
$ke = "$filenya?swkd=$swkd&tapelkd=$tapelkd&smtkd=$smtkd&keakd=$keakd&kelkd=$kelkd&".
			"rukd=$rukd&jnskd=$jnskd&mapelkd=$mapelkd&aspekkd=$aspekkd";
...
do
	...
	echo '<option value="'.$filenya.'?swkd='.$swkd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$st_kd.'">'.$st_smt.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?swkd='.$swkd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&jnskd='.$jn_kd.'">'.$jn_jns.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?swkd='.$swkd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&jnskd='.$jnskd.'&mapelkd='.$std_kd.'">'.$std_pel.'</option>';
	}
...
if (empty($smtkd))
	...
	{
	//query	  
	$qdata = mysql_query("SELECT m_aspek_prog_pddkn.*, m_aspek.*, m_aspek.kd AS makd ".
