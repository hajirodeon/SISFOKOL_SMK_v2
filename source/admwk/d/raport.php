...
do
	...
	echo '<option value="'.$filenya.'?swkd='.$swkd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$st_kd.'&smt='.$st_smt.'">'.$st_smt.'</option>';
	}
...
echo '</option>
<option value="'.$filenya.'?swkd='.$swkd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&smt='.$smt.'&jns=1">Raport Sisipan</option>
<option value="'.$filenya.'?swkd='.$swkd.'&tapelkd='.$tapelkd.'&keakd='.$keakd.'&kelkd='.$kelkd.'&rukd='.$rukd.'&smtkd='.$smtkd.'&smt='.$smt.'&jns=2">Raport Akhir Semester</option>
</select>
</td>
</tr>
</table>';
...
if (empty($tapelkd))
	...
	$redir = "raport$jns";
	$redir1 = "_pdf";
	echo "$redir$redir1.php?swkd=$swkd&keakd=$keakd&kelkd=$kelkd&rukd=$rukd&tapelkd=$tapelkd&smtkd=$smtkd";
