...
if ($tdty != 0)
	...
	do
		...
		$ykea_bid = nosql($rykea['bidang']);
		$ykea_prog = nosql($rykea['program']);
		...
		<td>'.$yru_ru.'</td>
		<td>
		<a href="d/detail.php?tapelkd='.$dty_tapelkd.'&keakd='.$dty_keakd.'&kelkd='.$dty_kelkd.'&rukd='.$dty_rukd.'" 
		title="DAFTAR SISWA. Tahun Pelajaran = '.$ytapel_thn1.'/'.$ytapel_thn2.', Keahlian = '.$ykea_bid.'-'.$ykea_prog.', Kelas = '.$ykel_kelas.', Ruang = '.$yru_ru.'">
		...
		title="JADWAL PELAJARAN. Tahun Pelajaran = '.$ytapel_thn1.'/'.$ytapel_thn2.', Keahlian = '.$ykea_bid.'-'.$ykea_prog.', Kelas = '.$ykel_kelas.', Ruang = '.$yru_ru.'">
		<img src="'.$sumber.'/img/preview.gif" width="16" height="16" border="0"></a>
		</td>
		</tr>';
		}
